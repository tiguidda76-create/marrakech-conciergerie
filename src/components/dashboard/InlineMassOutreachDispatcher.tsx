...
export const InlineMassOutreachDispatcher: React.FC<InlineMassOutreachDispatcherProps> = ({
  ...
  const handleLaunchMassOutreach = async () => {
    ...
    addLiveLog(`📡 Canal : ${selectedChannel} | Langue : ${lang} | Bouclier DNS MX Actif`, "info");
      ...
      try {
        ...
        if (selectedChannel === "EMAIL" || selectedChannel === "BOTH") {
          ...
          if (res.ok && resData.success) {
            ...
            addLiveLog(`✉️ [Gmail SMTP Pro] Email délivré à ${lead.title} (${resolvedEmail})`, "success");
        ...
        if (selectedChannel === "WHATSAPP" || selectedChannel === "BOTH") {
          ...
          addLiveLog(`💬 [WhatsApp] Pitch 1-clic préparé pour ${lead.title} (${finalPhone})`, "info");
    ...
    setIsCompleted(true);
    addLiveLog(`🏁 Campagne terminée : ${localSuccess} délivrés avec succès sur ${queue.length} !`, "success");
    onTelemetryRefresh();
  };
